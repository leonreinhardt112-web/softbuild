  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-foreground tracking-tight">Schriftverkehr</h1>
          <p className="text-sm text-muted-foreground mt-0.5">{eintraege.length} Einträge · globales Kommunikations-Center</p>
        </div>
